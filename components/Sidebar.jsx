...
const Sidebar = () => {
  return (
    <div className='col-span-1 row-span-1 sm:col-span-1'>
      ...
      <h2 className='mt-4 mb-4 text-6xl font-extrabold dark:text-white font-universHeading'><Image src={'/icons/intranet-icons_icon-quicklinks.png'} width={45} height={45} alt='quicklinks' /> Pathways</h2>
      ...
      <h2 className='mt-10 mb-4 text-6xl font-extrabold font-universHeading dark:text-white'><Image src={'/icons/intranet-icons_icon-policies.png'} width={45} height={45} alt='quicklinks' /><span className='ml-2'>Policies</span></h2>
      <div className="text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        <a
